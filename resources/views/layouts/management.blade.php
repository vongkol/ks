    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{url('/admin/management')}}">Management <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
    ...
    <div class="row">
        <nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar">
            <ul class="nav nav-pills flex-column" id="siderbar">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#" id="product">Product Management</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/admin/event')}}" id="event">Event Management</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{url('shop-owner')}}" id="shop-owner">Shop Owner Management</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{url('shop')}}" id="shop">Shop Management</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#" id="product">Customer Management</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#" id="product">Featured Product</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#" id="product">Ads Management</a>
                </li>
               
                <li class="nav-item">
                    <a class="nav-link" href="#" id="product">Slide Management</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#" id="product">Company Management</a>
                </li>
            </ul>
        </nav>
