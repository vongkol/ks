...
<head>
    ...
    <title>Company Management | Kspage</title>
    <!-- Styles -->
    <!-- Bootstrap core CSS -->
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{url('/admin/company-management')}}">Companies <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
    ...
    <div class="row">
        <nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar">
            <ul class="nav nav-pills flex-column" id="siderbar">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/admin/company')}}" id="menu_company">Company</a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/admin/company-category')}}" id="menu_company_category">Company Category</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/admin/business-type')}}" id="menu_business_type">Business Type</a>
                </li>
            </ul>
        </nav>
