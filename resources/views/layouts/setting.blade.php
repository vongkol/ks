    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{url('/admin/setting')}}">Settings <span class="sr-only">(current)</span></a>
            </li>
    ...
    <div class="row">
        <nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar">
            <ul class="nav nav-pills flex-column" id="siderbar">
                <li class="nav-item"><strong>General Settings</strong></li>
                
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/admin/slide')}}" id="menu_slide_show">Slide Show</a>
                </li>
                {{-- <li class="nav-item">
                    <a class="nav-link" href="#" id="user">Website Logo</a>
                </li> --}}
                {{-- <li class="nav-item">
