...
<head>
    ...
    <title>Career Management | Kspage</title>
    <!-- Styles -->
    <!-- Bootstrap core CSS -->
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{url('/admin/career-management')}}">Careers <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
    ...
    <div class="row">
        <nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar">
            <ul class="nav nav-pills flex-column" id="siderbar">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#" id="product">Job Listing</a>
                </li>
                <li class="nav-item">
                    <strong>Settings</strong>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#" id="product">Job Category</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#" id="product">Job Location</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#" id="product">Job Type</a>
                </li>
            </ul>
        </nav>
