...
<head>
    ...
    <title>School Management | Kspage</title>
    <!-- Styles -->
    <!-- Bootstrap core CSS -->
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{url('/admin/school-management')}}">Schools <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
    ...
    <div class="row">
        <nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar">
            <ul class="nav nav-pills flex-column" id="siderbar">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/admin/school')}}" id="menu_school">School</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/admin/school-program')}}" id="menu_school_program">School Program</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{url('admin/scholarship')}}" id="menu_scholarship">Scholarship</a>
                </li>
                <li class="nav-item">
                    <strong>Settings</strong>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/admin/school-category')}}" id="menu_school_category">School Category</a>
                </li>
                
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/admin/program-category')}}" id="menu_program_category">Program Category</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/admin/scholarship-category')}}" id="menu_scholarship_category">Scholarship Category</a>
                </li>
            </ul>
        </nav>
