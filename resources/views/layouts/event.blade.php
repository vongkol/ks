...
<head>
    ...
    <title>Event Management | Kspage</title>
    <!-- Styles -->
    <!-- Bootstrap core CSS -->
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
                    <a class="nav-link" href="{{url('/admin/event-management')}}">Events <span class="sr-only">(current)</span></a>
                </li>
            <li class="nav-item">
    ...
    <div class="row">
        <nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar">
            <ul class="nav nav-pills flex-column" id="siderbar">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/admin/event')}}" id="menu_event">Event</a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/admin/event-category')}}" id="menu_event_category">Event Category</a>
                </li>
            </ul>
        </nav>
