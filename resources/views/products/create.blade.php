    ...
    <div class="row">
        <div class="col-lg-12">
           <strong>Create New Product</strong>&nbsp;&nbsp;
            ...
            @endif
            <form action="{{url('/admin/product/save')}}" method="post" id="frm" class="form-horizontal" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                               <input type="number" class="form-control" id="quantity" name="quantity" min="0" max="9999" step="1" value="1" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="price" class="control-label col-sm-3 lb">Price<span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                               <input type="number" class="form-control" id="price" name="price" min="0" max="9999" step="0.1" value="0" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="sell_price" class="control-label col-sm-3 lb">Sell Price<span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                               <input type="number" class="form-control" id="sell_price" name="sell_price" min="0" max="9999" step="0.1" value="0" required>
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="file" class="form-control" id="photo" name="photo" onchange="loadFile(event)"><span class="text-danger">(500 x 400)</span>
                                <p></p>
                                <div>
                                    <img src="{{asset('uploads/products/featured/image-default.png')}}" alt="" width="200" style="border:1px solid #ccc" id="preview">
                                </div>
                            </div>
                        </div>
                    </div>
