...
@section('content')
    <div class="row">
        <div class="col-lg-12">
           <strong>Edit Business Type</strong>&nbsp;&nbsp;
            ...
            @endif
            <form action="{{url('/admin/business-type/update')}}" method="post" id="frm" class="form-horizontal">
                {{csrf_field()}}
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="name" value="{{$business_type->name}}" name="name" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group row">
