    ...
    <div class="row">
        <div class="col-lg-12">
           <strong>Edit Review</strong>&nbsp;&nbsp;
            ...
            @endif
            <form action="{{url('/admin/review/update')}}" enctype="multipart/form-data" method="post" id="frm" class="form-horizontal">
                {{csrf_field()}}
                    ...
                    <div class="col-sm-6">
                            ...
                            <div class="col-sm-9">
                                <select name="category" id="category" class="form-control">
                                    @foreach($categories as $c)
                                        <option value="{{$c->id}}" {{$c->id==$review->category_id?'selected':''}}>{{$c->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <br>
                                <img src="{{asset('uploads/reviews/'.$review->featured_image)}}" alt="" width="70" id="preview">
                            </div>
                        </div>
                        {{-- <div class="form-group row">
