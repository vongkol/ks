...
@section('content')
    <div class="row">
        <div class="col-lg-12">
           <strong>Create New Review Category</strong>&nbsp;&nbsp;
            ...
            @endif
            <form action="{{url('/admin/review-category/save')}}" enctype="multipart/form-data" method="post" id="frm" class="form-horizontal">
                {{csrf_field()}}
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <br>
                                <img src="{{asset('uploads/reviews/icon/default.png')}}" alt="" width="72" id="preview">
                            </div>
                        </div>
                        <div class="form-group row">
