...
@section('content')
    <div class="row">
        <div class="col-lg-12">
           <strong>Create New School Program</strong>&nbsp;&nbsp;
            ...
            @endif
            <form action="{{url('/admin/school-program/save')}}" enctype="multipart/form-data" method="post" id="frm" class="form-horizontal">
                {{csrf_field()}}
                <div class="row">
                    <div class="col-sm-6">
                            ...
                            <div class="col-sm-9">
                                <select name="school_id" id="school_id" class="form-control sl" required>
                                    @foreach($schools as $school)
                                        <option value="{{$school->id}}">{{$school->name_khmer}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="col-md-10">
                            ...
                            <br><img src="{{asset('uploads/events/featured_image/default.svg')}}" alt="" width="100" id="preview">
                        </div>
