...
@section('content')
    <div class="row">
        <div class="col-lg-12">
           <strong>Create New School Category</strong>&nbsp;&nbsp;
            ...
            @endif
            <form action="{{url('/admin/school-category/save')}}" enctype="multipart/form-data" method="post" id="frm" class="form-horizontal">
                {{csrf_field()}}
                <div class="row">
                    <div class="col-sm-6">
