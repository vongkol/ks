...
<div class="box-head top-head">
    <h3 class="head-title text-center"><img src="{{asset('/uploads/events/icon/'.$event_category->icon)}}" width="30" alt=""> {{$event_category->name}} - Event List</h3>
</div>
<div class="container">
    <div class="row">
        <div class="col-md-3">
            ...
            <div class="col-md-9">
                <div class="row">
                    @foreach($events as $ev)
                        <div class="col-lg-4 col-md-4 mb20 pd-0">
