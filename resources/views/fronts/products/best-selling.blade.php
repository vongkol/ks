...
@section('content')
    <div class="box-head top-head">
        <h3 class="head-title text-center">Best Selling Products</h3>
    </div>
    <?php
                        ...
                        <li class="has-sub">
                            ...
                            <ul>
                                ...
                                <?php $counter2 = DB::table('products')
                                    ...
                                    ->count();  
                                ?>
                                    <li><a href="{{url('/product/best/sell/'.$s->id)}}">{{$s->name}} <span class="text-danger"> ({{$counter2}})</span></a></li>
                                @endforeach
                            </ul>
                        </li>
                    @else
                     <li><a href="{{url('/product/best/sell/'.$c->id)}}">
