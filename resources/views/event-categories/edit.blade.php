    ...
    <div class="row">
        <div class="col-lg-12">
           <strong>Edit Event Category</strong>&nbsp;&nbsp;
            ...
            @endif
            <form action="{{url('/admin/event-category/update')}}" enctype="multipart/form-data" method="post" id="frm" class="form-horizontal">
                {{csrf_field()}}
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="name" name="name" class="form-control" value="{{$event_category->name}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select name="parent_id" id="parent_id" class="form-control sl">
                                    ...
                                    @foreach($event_categories as $ec)
                                        <option value="{{$ec->id}}" {{$ec->id==$event_category->parent_id?'selected':''}}>{{$ec->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <br>
                                @if($event_category->icon !== null)
                                    <img src="{{asset('uploads/events/icon/'.$event_category->icon)}}" alt="" width="72" id="preview">
                                @else
