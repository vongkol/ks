...
@section('content')
    <div class="row">
        <div class="col-lg-12">
           <strong>Create New Company Category</strong>&nbsp;&nbsp;
            ...
            @endif
            <form action="{{url('/admin/company-category/save')}}" enctype="multipart/form-data" method="post" id="frm" class="form-horizontal">
                {{csrf_field()}}
                <div class="row">
                    <div class="col-sm-6">
                            ...
                            <div class="col-sm-9">
                                <select name="parent_id" id="parent_id" class="form-control sl">
                                    ...
                                    @foreach($company_categories as $company_category)
                                        <option value="{{$company_category->id}}">{{$company_category->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="icon" class="control-label col-sm-3 lb">Icon​​ <span class="text-danger">(25 x 25)</span></label>
                            <div class="col-sm-9">
